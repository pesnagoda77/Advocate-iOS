...
class Client {
    ...
    init(lastName: String, firstName: String, middleName: String = "", phone: String = "", email: String = "") {
        self.id = UUID()
...
class Case {
    ...
    init(number: String, title: String, description: String = "", client: Client? = nil) {
        self.id = UUID()
        self.number = number
        self.title = title
        self.description = description
        self.status = .active
        self.paymentMethod = .hourly
        self.createdAt = Date()
        self.client = client
...
class Event {
    ...
    init(type: EventType, title: String, date: Date, case: Case? = nil) {
        self.id = UUID()
        self.type = type
        self.title = title
        self.description = ""
...
class Payment {
    ...
    init(amount: Double, date: Date, note: String = "", case: Case? = nil) {
        self.id = UUID()
        self.amount = amount
        self.date = date
        self.note = note
